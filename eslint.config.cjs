...
const rendererGlobals = Object.fromEntries([
  'MAX_PORTRAIT_VARIANTS', 'state', 'resetSelection', 'hasMaximumPortraits',
  ...
  'duplicateSelectedCharacter', 'uniqueCollectionName', 'duplicateActiveGallery', 'copyDna', 'saveLibrary', 'referencedImagePaths', 'cleanupUnusedPortraits', 'exportCollection', 'importCollection',
  ...
  'desktop', 'app', 'escapeHtml', 'noteTags', 'highlightedNoteMarkup', 'characterTags', 'activeFilterCount', 'availableTags', 'clearFilters', 'getGallery', 'getCharacters', 'getActiveCharacter', 'gallerySortMode', 'normalizedCharacter', 'colorFor', 'visibleCharacters', 'imageUrlFor', 'coverVariantIndex', 'portraitMarkup', 'icon', 'render', 'focusWithoutScroll', 'updateImageUrls', 'bindEvents', 'openContextMenu', 'bindTablePortraitPreviews', 'handleContextAction', 'bindCardDragAndDrop', 'bindCollectionDragAndDrop', 'bindReorderableList', 'saveCollectionOrder', 'setSortMode', 'saveCustomCardOrder', 'cycleCardPortrait', 'toggleFavorite', 'saveCharacterTitle', 'startBatchSelection', 'cancelBatchSelection', 'toggleBatchSelection', 'selectAllVisibleCharacters', 'restoreSelectionFocus', 'action', 'showToast', 'readableError', 'chooseImage', 'pasteClipboardPortrait', 'pasteClipboardContent', 'bindModalDelegation', 'runModalAction', 'installKeyboardShortcuts', 'installClipboardPasteHandler', 'openClipboardFile', 'openClipboardSource', 'boot',
